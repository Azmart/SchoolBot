...
if authentication_status:
    ...
    if st.sidebar.button("च्याट गर्नुहोस्।"):
        st.session_state.start_chat = True
        thread = client.beta.threads.create()
        st.session_state.thread_id = thread.id

    st.title("मेरो ए.आई शिक्षक")
    st.write(f"नमस्कार {name}🙏")

    if st.button("बन्द गर्नुहोस्।"):
    ...
    if st.session_state.start_chat:
        ...
        st.write("सुरु गर्न 'च्याट गर्नुहोस्' बटन थिच्नुहोस्।")

elif authentication_status == False:
    st.error('प्रयोगकर्ता नाम/पासवर्ड गलत छ।')

elif authentication_status == None:
    st.warning('आफ्नो प्रयोगकर्ता नाम र पासवर्ड प्रविष्ट गर्नुहोस्')
